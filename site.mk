...
ifeq ($(GLUON_TARGET),ath79-generic)
	...
	# devices not yet supported in ath79 but formerly supported in ar71xx are commented out
#	GLUON_avm-fritz-wlan-repeater-300e_SITE_PACKAGES += $(NO_USB_PACKAGES_WITHOUT_HID)
	...
	GLUON_tp-link-archer-c6-v2_SITE_PACKAGES += $(NO_USB_PACKAGES_WITHOUT_HID)
...
#	GLUON_tp-link-tl-wr842n-v1_SITE_PACKAGES += $(NO_USB_PACKAGES_WITHOUT_HID)
#	GLUON_tp-link-tl-wr842n-v2_SITE_PACKAGES += $(NO_USB_PACKAGES_WITHOUT_HID)
#	GLUON_tp-link-tl-wr1043nd-v1_SITE_PACKAGES += $(NO_USB_PACKAGES_WITHOUT_HID)
...
#	GLUON_ubiquiti-nanostation-loco-m-xm_SITE_PACKAGES += $(NO_USB_PACKAGES_WITHOUT_HID)
#	GLUON_ubiquiti-nanostation-loco-m-xw_SITE_PACKAGES += $(NO_USB_PACKAGES_WITHOUT_HID)
#	GLUON_ubiquiti-nanostation-m-xm_SITE_PACKAGES += $(NO_USB_PACKAGES_WITHOUT_HID)
